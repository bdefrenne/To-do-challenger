# Set up the todo MCP workflow in your project

> **Mirror.** The Settings page hands this text out too (**Settings → “Make your coding
> agent work from this board”** → *Copy instructions*), from `src/lib/todoSetupGuide.ts` —
> the deployed app can't read the repo. This doc is the source of truth: after editing it,
> run `npm run gen:setup-guide` to regenerate that module.
